...
"use strict";
(function(){
  // ---- 100% static list (edit here if you need to add/remove) ----
  var SPECIALTIES = [
    "Addiction Counselor",
  ...
  function ensureField(){
    ...
    if (form) {
      ...
      if (form.firstElementChild) {
        form.insertBefore(field, form.firstElementChild.nextSibling);
      } else {
  ...
  function populate(sel){
    ...
    var def = localStorage.getItem("specialty") || SPECIALTIES[0];
    sel.value = def;
  }
  ...
  function boot(){
    ...
    sel.addEventListener("change", function(){
      try { localStorage.setItem("specialty", sel.value); } catch(e){}
    }, { passive: true });
    // Convenience getter
