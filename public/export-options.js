...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Toggle button visibility based on note type
  ...
  btn.addEventListener("click", async () => {
    try {
      ...
      if (noteType === "soap") {
        ...
        // BIRP fields
        note.behavior = document.getElementById("birpBehavior").value;
        note.intervention = document.getElementById("birpIntervention").value;
        note.response = document.getElementById("birpResponse").value;
        note.plan = document.getElementById("birpPlan").value;
      }

      // Debug logs
      console.log(`[export-options] exporting ${noteType} note`, note);

      // Pick endpoint
      const endpoint = noteType === "birp" ? "/export/pdf/birp" : "/export/pdf";
